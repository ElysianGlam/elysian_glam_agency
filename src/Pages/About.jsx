...
import { introduction, logo } from "../Constants/constants";
    ...
    <div id="about" className="w-full flex justify-center overflow-hidden-web">
      <div className="w-full xl:w-[70%] flex flex-col pb-16">
        <div className="w-full">
          <SectionTitle title="О НАС" subtitle="Узнай больше" />
        </div>
          ...
          <div className="w-full md:w-[50%] md:h-full flex items-center mt-10">
            <LazyMotion features={domAnimation} strict>
              ...
              >
                ...
                <span className="text-lg">{introduction.text[1]}</span>
                <span className="text-lg">{introduction.text[2]}</span>
                <span className="text-lg">{introduction.text[3]}</span>
              </m.p>
            </LazyMotion>
          </div>
